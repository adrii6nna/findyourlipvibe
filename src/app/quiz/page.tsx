        ...
        <div className="space-y-4">
          {current.options.map((opt, idx) => (
            <button
              ...
              className="w-full py-3 px-4 bg-[#FFF8F8]/60 border-[2px] border-[#A674C1] rounded-full shadow-[0_6px_0_0_#A674C1] text-[#6C6177] font-semibold hover:translate-y-[2px] active:translate-y-[4px] transition-all duration-200"
            >
              {opt.text}
            </button>
          ))}
